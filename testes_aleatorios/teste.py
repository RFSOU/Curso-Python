...
def rasparUSP(pag, nArq):
    ...
    for j in range(pag, min(896, pag + 100)):
        ...
        html = urlopen(
            'https://uspdigital.usp.br/portaltransparencia/portaltransparenciaListar?paginar=s&dtainictc=01%2F12%2F2016&nompes=&nomundorg=&nomdepset=&tipcon=&tipcla=&nomabvfnc=&Submit=Solicitar+pesquisa&reload=buscar&imagem=S&print=true&chars=21ni&pag=' + str(
                j))
